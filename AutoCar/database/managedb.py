...
class ManageDB:
    ...
    def add_carshare_to_collection(self, carshareID, name, description, users, carIDs):
        ...
        if self.find_carshare(carshareID) is None:
            carsharedb.add_carshare_to_collection(carshareID, name, description, users, carIDs, get_curr_utc(), self)
            for carID in carIDs:
                self.checkout_car(carID, carshareID)
